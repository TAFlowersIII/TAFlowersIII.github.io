...
export default function Contact() {
  return (
    <div className="contact" id='contact'>
      ...
      <br></br>
      <h4>I was born in New York City, and am currently living in Atlanta, Georgia. I've spent many years living in the Midwest and Far West USA, in urban, suburban, and rural environments. I believe this pan-American background helps me relate to Americans from all walks of life.</h4>
      <br></br>
