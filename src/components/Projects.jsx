      ...
      <div className={styles.card1}>
        ...
        <div className={styles.card1container}>
          ...
          <div id={styles.card1links}>
            <a href='https://taflowersiii.github.io/SS808-Simons-Sampler/'>View On Github</a> <span> | </span> <a href='https://taflowersiii.github.io/SS808-Simons-Sampler/'>View Deployment</a>
          </div>
        </div>
